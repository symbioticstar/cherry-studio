...
const swaggerOptions: swaggerJSDoc.Options = {
  definition: {
    openapi: '3.0.0',
    info: {
      title: 'Xerry Studio API',
      version: '1.0.0',
      description: 'OpenAI-compatible API for Xerry Studio with additional Cherry-specific endpoints',
      contact: {
        name: 'Xerry Studio',
    ...
    components: {
      securitySchemes: {
        BearerAuth: {
          ...
          scheme: 'bearer',
          bearerFormat: 'JWT',
          description: 'Use the API key from Xerry Studio settings'
        }
      },
      schemas: {
        Error: {
...
export function setupOpenAPIDocumentation(app: Express) {
  try {
    ...
    app.use(
      ...
      `,
        customSiteTitle: 'Xerry Studio API Documentation'
      })
    )
