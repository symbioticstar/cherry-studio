/**
 * AI SDK 到 Xerry Studio Chunk 适配器
 * 用于将 AI SDK 的 fullStream 转换为 Xerry Studio 的 chunk 格式
 */
...
/**
 * AI SDK 到 Xerry Studio Chunk 适配器类
 * 处理 fullStream 到 Xerry Studio chunk 的转换
 */
export class AiSdkToChunkAdapter {
  ...
  /**
   * 读取 fullStream 并转换为 Xerry Studio chunks
  ...
  /**
   * 转换 AI SDK chunk 为 Xerry Studio chunk 并调用回调
